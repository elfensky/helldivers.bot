        ...
        <div className="grid grid-cols-[1fr_4px]">
            <div className="flex flex-col gap-4 bg-surface-1 p-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div>
                        <p className="text-xs uppercase text-text-muted">Users</p>
                        <p className="text-lg font-semibold text-text">{totalUsers}</p>
                    </div>
                    <div>
                        <p className="text-xs uppercase text-text-muted">API Keys</p>
                        <p className="text-lg font-semibold text-text">{totalApiKeys}</p>
                    </div>
                    <div>
                        <p className="text-xs uppercase text-text-muted">Last Poll</p>
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <span className={`text-sm ${workerHealthy ? 'text-green-400' : 'text-danger'}`}>
