...
function HeroBackup({ data }) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="mr-4 ml-4 flex h-full flex-col gap-4 sm:mr-12 sm:ml-12 md:mr-0 lg:mr-0 lg:ml-24 xl:gap-8">
            ...
            >
                <div className="mr-4 ml-4 flex h-full flex-wrap items-center justify-between sm:mr-12 sm:ml-12 md:mr-0 lg:mr-24 lg:ml-24">
                    <HeroStats data={data} />
                </div>
            </section>
...
function Features() {
    return (
        <section
            id="features"
            className="card flex w-full flex-col sm:max-w-2/3 sm:flex-grow"
        >
...
function Roadmap() {
    return (
        <section id="roadmap" className="card w-full sm:max-w-1/2">
...
function Buy() {
    return (
        <section id="buy" className="card w-full sm:max-w-1/2">
