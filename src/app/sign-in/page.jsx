    ...
    return (
        <div className="flex min-h-[60dvh] flex-col items-center justify-center gap-6">
            ...
            <div className="flex flex-col gap-3">
                ...
                <button
                    className="flex w-64 cursor-pointer items-center justify-center gap-3 border border-ghost px-6 py-3 transition-opacity hover:opacity-90 active:scale-[0.98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary"
