...
| *Will it fail at all* | The outcome verdict (`eventForecast` — the Behind/On track wording on the event cards, same predicate as their ▲/▼ pace delta) | Reused verbatim as the clock's conditional wording |
