...
| --- | --- | --- |
| Bugs | 0.298 / 0.525 | **0.210 / 0.456** |
| Cyborgs | 0.320 / 0.544 | **0.252 / 0.503** |
| Illuminate | 0.331 / 0.568 | **0.290 / 0.526** |

So the correction makes the displayed window more *honest* without making the central estimate more *accurate*. For a heads-up, that is the trade worth taking, and it is kept. Coverage improves too — the line fires before 91.5–95.2% of attacks, up from 90.6–94.4%.
