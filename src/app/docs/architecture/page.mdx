...
import { DEFINITION_LR, DEFINITION_TD } from '@/shared/components/DataFlowDiagram/dataFlowDefinition';
...
<MermaidDiagram id="data-flow" definition={DEFINITION_LR} mobileDefinition={DEFINITION_TD} config={dataFlowConfig} />
