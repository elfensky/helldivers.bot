...
2. `updateSeason(season)` calls `fetchSeason(season)` (official API) and upserts into `rebroadcast_season`, `h1_season`, `h1_event`, `h1_snapshot`, `h1_introduction_order`, `h1_points_max`
