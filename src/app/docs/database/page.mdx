...
| `introduction_order` | `Int[]`     | `INTEGER[]`     | `@default([])` — faction reveal order, indexed by faction (enemy 0, 1, 2). The **value** is a 0-based rank: `0` = the faction the war started against, `1`/`2` = mid-war arrivals, `255` = never introduced. |
