...
When a baseline changes, review the diff PNG under `.vitest-attachments/` before accepting it. Visual tests are not part of `npm run test:unit` and do not run in CI yet.
