 ...
 * contested regions.
 *
 * Used by both `ArchiveMap` (historical season view) and `HomeGalaxyOverlay`
 * (homepage scrollytelling — same time-travel effect for recent events).
 */
export function computeMapStateAtEvent(selectedEvent, data) {
