...
/**
 * Fires a single `preference-snapshot` Umami event per session, capturing
 * the user's current preferences. Complements the existing click-event
 * tracking on each toggle: clicks measure churn, snapshots measure state
 * distribution (including users who never touch a toggle).
 *
