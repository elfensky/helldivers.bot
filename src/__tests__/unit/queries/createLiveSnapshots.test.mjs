...
const mockStats = [
    { enemy: 0, season_duration: 100, players: 50, total_unique_players: 200, missions: 10, successful_missions: 8, total_mission_difficulty: 30, completed_planets: 2, defend_events: 3, successful_defend_events: 2, attack_events: 1, successful_attack_events: 1, deaths: 500, kills: 1000, accidentals: 50, shots: 5000, hits: 3000 },
    { enemy: 1, season_duration: 100, players: 40, total_unique_players: 180, missions: 8, successful_missions: 6, total_mission_difficulty: 25, completed_planets: 1, defend_events: 2, successful_defend_events: 1, attack_events: 2, successful_attack_events: 1, deaths: 400, kills: 800, accidentals: 40, shots: 4000, hits: 2500 },
    { enemy: 2, season_duration: 100, players: 30, total_unique_players: 150, missions: 6, successful_missions: 4, total_mission_difficulty: 20, completed_planets: 1, defend_events: 1, successful_defend_events: 1, attack_events: 1, successful_attack_events: 0, deaths: 300, kills: 600, accidentals: 30, shots: 3000, hits: 2000 },
];
...
describe('queryCreateLiveSnapshots', () => {
    ...
    test('processes all 3 enemy factions', async () => {
        const mockRecords = mockStats.map((s, i) => ({ id: i + 1, season: 5, enemy: s.enemy, time: 1000 }));
